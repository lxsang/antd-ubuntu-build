        ...
        <div id = "top">
            <div id = "navbar" class = "<?=cls?>">
                ...
                <ul>
                        ...
                        <li><i class = "fa fa-envelope"></i><a href="#" onclick="mailtoMe('https://lxsang.me/grs')" >Contact</a></li>
                        <?lua
                        if not HEADER.mobile then
                        ?>
                        <li> <i class = "fa fa-paper-plane"></i><a href="#" onclick="subscribe('https://lxsang.me/grs')">Subscribe</a></li>
