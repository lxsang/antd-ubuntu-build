...
(function() {
  ...
  UserService = (function(superClass) {
    ...
    function UserService(args) {
      UserService.__super__.constructor.call(this, "UserService", args);
      this.text = this.systemsetting.user.username;
    ...
    UserService.prototype.init = function() {
      ...
      return this.onmenuselect = function(d) {
        if (d.item.data.dataid === "sys-logout") {
          return me._api.handler.logout();
        }
        return me.notify("This feature is not implemented yet");
      };
    };

    UserService.prototype.awake = function(e) {};

    UserService.prototype.cleanup = function(evt) {};
